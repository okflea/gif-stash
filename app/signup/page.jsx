  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center absolute top-1/3 glass w-full p-5">
      ...
      <form className="bg-slate-300 rounded-lg p-8 shadow-md">
        <div className="mb-6">
          <label htmlFor="name" className="block text-slate-700 tmxt-gray-700 font-semibold mb-2">
            Name
          </label>
          <input
            type="text"
      ...
      <p className="text-gray-700 text-sm mt-4">
        ...
        <Link href="/login" className="text-slate-800 font-semibold hover:text-slate-600 ">
          Log in
        </Link>
      </p>
    </div>
