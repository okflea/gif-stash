...
const GifContainer = (props) => {
  ...
  const handleFavourite = () => {
    ...
    if (isFavourite === true) {
      ...
      setFavourites([...favourites, { id: id, name: name, url: url, isFav: isFav }])
    }
  }
    ...
    <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 glass rounded-lg m-1">
      ...
      <div className='flex flex-row justify-between m-2'>
        ...
        <div onClick={handleFavourite}>
          <svg width="30px" height="30px" viewBox="0 0 24 24" fill={isFav ? 'gold' : 'none'} xmlns="http://www.w3.org/2000/svg">
