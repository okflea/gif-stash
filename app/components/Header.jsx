      ...
      <nav className="container mx-auto px-4 py-6 md:flex md:justify-between md:items-center">
        ...
        >
          <div className="text-sm md:flex-grow">
            <Link href="/" className="block mt-4 md:inline-block md:mt-0 text-gray-500 hover:text-white mr-4">
              Home
            </Link>
            <Link className="block mt-4 md:inline-block md:mt-0 text-gray-500 hover:text-white mr-4" href="/about">
              About
            </Link>
            <Link className="block mt-4 md:inline-block md:mt-0 text-gray-500 hover:text-white" href="/contact">
              Contact
            </Link>
          </div>
        </div>
