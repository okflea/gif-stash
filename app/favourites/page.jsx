  ...
  return (
    <div>
      <div
        ...
        {favourites.map((gif) => (
          <GifContainer key={gif.id} id={gif.id} name={gif.title} url={gif.url} isFav={true} userId={userId} isLoaded={isLoaded} favourites={favourites} setfavourites={setfavourites}/>
        ))}
      </div>
    </div>
  )
